  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1400px] p-4">
        ...
        <div className="mb-4 flex items-center justify-between rounded-md border border-accent/[0.25] bg-accent/[0.06] px-3 py-2 font-mono text-[11px] text-muted-foreground animate-rise stagger-2">
          <span>
            ◆ <span className="text-[hsl(0_68%_33%)] font-semibold">Guardrail:</span> {guardrail}
          </span>
